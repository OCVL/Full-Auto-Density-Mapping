function [ pseudoim, maxrho ] = imcart2pseudopolar( im, rhoSampling, thetaSampling, location, method, rhoStart, rhoEnd )
...
if ~exist('rhoEnd','var') || isempty(rhoEnd)
     rhoEnd = floor(min(size(im))/2)-1;
end
